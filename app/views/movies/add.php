                            ...
                            <form role="form">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="movietile" placeholder="movie title">
                                    </div>
                                    <div class="form-group">
                                        <label>Genre</label>
                                        <select class="select2" multiple="multiple" data-placeholder="Select movie Genre" style="width: 100%;">
