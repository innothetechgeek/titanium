...
<head>
    ...
    <link rel="stylesheet" href="<?php url('plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') ?>">
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php url('plugins/icheck-bootstrap/icheck-bootstrap.min.css') ?>">
    <!-- JQVMap -->
    <link rel="stylesheet" href="<?php url('plugins/jqvmap/jqvmap.min.css') ?>">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php url('assets/css/admin_template/adminlte.min.css') ?>" >
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="<?php url('plugins/overlayScrollbars/css/OverlayScrollbars.min.css') ?>">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="<?php url('plugins/daterangepicker/daterangepicker.css') ?>">
    <!-- summernote -->
...
<!-- jQuery -->
<script src="assets/js/admin_template/jquery/jquery.min.js"></script>
<!-- jQuery UI 1.11.4 -->
<script src="assets/js/admin_template/jquery/jquery-ui/jquery-ui.min.js"></script>
