...
<!-- jQuery -->
<script src="http://<?= $_SERVER['HTTP_HOST']?>/titanium/plugins/jquery/jquery.min.js"></script>
<!-- Bootstrap 4 -->
<script src="http://<?= $_SERVER['HTTP_HOST']?>/titanium/plugins/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- AdminLTE App -->
